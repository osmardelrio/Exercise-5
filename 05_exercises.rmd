...
#was unable to upload files in png format for the running and swimming icons (would not let me do it from downloads either)
...
geom_image(data = panama_bike,
           aes(x = lon, 
               ...
               image = bike_image), 
           size = 0.1) +
geom_image(data = panama_run,
           aes(x = lon, 
               y = lat,
               image = run_image), 
           size = 0.1) +
geom_image(data = panama_swim,
           aes(x = lon, 
               y = lat,
               image = swim_image), 
           size = 0.1) +
